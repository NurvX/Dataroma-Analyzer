...
class ReadmeGenerator:
    ...
    def _generate_advanced_section(self, results: Dict[str, pd.DataFrame], 
        ...
        advanced_reports = {
            "position_building_timeline": ("📈 Position buildup/reduction over time", "Quarter-by-quarter view of how managers accumulate & distribute positions"),
            "accumulation_vs_distribution": ("🔄 Current phase tracking", "Identifies which positions are being built vs reduced RIGHT NOW"),
            "position_flip_points": ("🔀 Accumulation→Distribution transitions", "Pinpoints when managers switched from building to reducing"),
