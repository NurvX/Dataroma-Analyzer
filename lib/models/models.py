...
class Holding:
    ...
    Note: The `percentage` field is deprecated. Use `portfolio_percent` instead.
    """
    ...
    shares: int
    value: float
    percentage: float  # DEPRECATED: Use portfolio_percent instead
    ...
    def __post_init__(self) -> None:
        """Synchronize percentage and portfolio_percent fields."""
        # Sync values: prefer portfolio_percent if set, otherwise use percentage
        if self.portfolio_percent == 0.0 and self.percentage != 0.0:
            self.portfolio_percent = self.percentage
        elif self.percentage == 0.0 and self.portfolio_percent != 0.0:
            self.percentage = self.portfolio_percent
